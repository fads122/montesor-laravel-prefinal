            ...
            <div class="col-lg-4">
               <div class="card profile-card-2">
                ...
                <div class="card-body pt-5">
                    <img src="https://via.placeholder.com/110x110" alt="profile-image" c    lass="profile">
                    <h5 class="card-title">@foreach ($professors as $professor)
                        <p>{{ $professor->first_name }} {{ $professor->middle_name }} {{ $professor->last_name }}</p>
                    @endforeach</h5>
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane active" id="profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <h5 class="mt-2 mb-3"><span class="fa fa-clock-o ion-clock float-right"></span>Specialization</h5>
                        ...
                        <!--/row-->
                        <a href="{{ route('edit') }}" class="btn btn-primary" style="margin-top: 20px">Edit Profile</a>
                    </div>
